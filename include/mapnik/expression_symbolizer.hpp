...
#ifndef MAPNIK_EXPRESSION_SYMBOLIZER_HPP
#define MAPNIK_EXPRESSION_SYMBOLIZER_HPP
...
class MAPNIK_DECL expression_symbolizer_base {
    public:
...
#endif //MAPNIK_EXPRESSION_SYMBOLIZER_HPP
